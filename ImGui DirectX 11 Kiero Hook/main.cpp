...
HMODULE g_hModule = NULL; //handle do modulo
...
void InitImGui()
{
	...
	io.Fonts->AddFontFromFileTTF("C:\\Users\\Administrator\\Documents\\smallest_pixel-7.ttf", 13.0f);
...
{
	ImGui::SetNextWindowPos(ImVec2(5, 5)); // Posição no canto superior esquerdo
	ImGui::Begin(" Youtube ", NULL, ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_AlwaysAutoResize);
	ImGui::Text("DayZ with KieroHook");
	ImGui::End();
}
...
HRESULT __stdcall hkPresent(IDXGISwapChain* pSwapChain, UINT SyncInterval, UINT Flags)
{
	...
	ImGui::Begin("YoutubeKieroHook BR");
	...
	if (ImGui::BeginTabBar("Tabs"))
	{
		if (ImGui::BeginTabItem("AimBot"))
		{
			...
			ImGui::SliderFloat("Fov Value", &FovValue, 0.0f, 1000.0f, "FOV = %.1f");
			ImGui::EndTabItem();
		}
		if (ImGui::BeginTabItem("Visuals"))
		{
			if (ImGui::BeginChild("VisualsTabs", ImVec2(0, 0), true, ImGuiWindowFlags_NoResize))
			{
				if (ImGui::BeginTabBar("VisualsTabBar"))
				{
					if (ImGui::BeginTabItem("esp player"))
					{
						...
						ImGui::Checkbox("Player Skeleton", &PlayerSkeleton);
						ImGui::Checkbox("Player Name", &PlayerName);
						ImGui::EndTabItem();
					}
					if (ImGui::BeginTabItem("Zombie Esp"))
					{
						ImGui::Checkbox("Zombie box", &ZombieBox);
						ImGui::Checkbox("Zombie Skeleton", &ZombieSkeleton);
						ImGui::EndTabItem();
					}
					if (ImGui::BeginTabItem("Car Esp"))
					{
						ImGui::Checkbox("Draw Cars", &EspCar);
						ImGui::Checkbox("Car Parts", &CarParts);
						ImGui::Checkbox("Car Engine", &CarEngine);
						ImGui::EndTabItem();
					}
					if (ImGui::BeginTabItem("Esp Items"))
					{
						ImGui::Checkbox("Proxy Magazines", &ProxyMagazines);
		...
		{
			ImGui::Text("Aqui seria a aba de misc");
			ImGui::EndTabItem();
		}
		if (ImGui::BeginTabItem("Config"))
		{
			if (ImGui::Button("Desinjetar dll"))
			{
				kiero::shutdown();
